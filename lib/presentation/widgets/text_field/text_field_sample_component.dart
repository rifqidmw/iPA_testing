...
class TextFieldSampleComponent extends StatefulWidget {
  TextFieldSampleComponent(
      {super.key,
  ...
  @override
  State<TextFieldSampleComponent> createState() => _TextFieldSampleComponentState();
}

class _TextFieldSampleComponentState extends State<TextFieldSampleComponent> {
